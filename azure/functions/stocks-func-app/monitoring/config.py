...
WHEEL_INCLUDE_FINVIZ = (os.getenv("WHEEL_INCLUDE_FINVIZ", "1") == "1")
WHEEL_FINVIZ_TOPN = int(os.getenv("WHEEL_FINVIZ_TOPN", "25"))
WHEEL_USE_EQUITY_FILTERS = (os.getenv("WHEEL_USE_EQUITY_FILTERS", "0") == "1")
